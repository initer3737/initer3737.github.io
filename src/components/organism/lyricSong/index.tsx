...
export default function LyricSong() {
  return (
    <div className='row'>
        ...
        <div className="col-12 mt-5 m-auto bg-4 text-light mb-3 px-2 py-4">
          <div className="text-center ">
            <h5>
              <Icon variant={''} icon={'pencil-square'} name={' '}/> 歌詞
            </h5>
          </div>
    ...
    <div className="col-12 mt-5 m-auto bg-4 text-light mb-3 px-2 py-4">
      <div className="text-center ">
        <h5>
        <Icon variant={''} icon={'pencil-square'} name={' '}/>yasashi suisei
        </h5>
      </div>
      <div className="text-start fs-5 px-5 col-12 col-md-6  m-auto">
    ...
    <div className="col-12 mt-5 m-auto bg-4 text-light mb-3 px-2 py-4">
      ...
      <div className="col-12 mt-5 m-auto bg-4 text-light mb-3 px-2 py-4">
        ...
        <div className="text-start fs-5 px-5 col-12 col-md-6  m-auto">
          Seperti tenggelam dan melebur ke dalamnya Langit bagi kita membentang
      ...
      <div className="col-12 mt-5 m-auto bg-4 text-light mb-3 px-2 py-4">
          <div className="text-center ">
            <h5>
              <Icon variant={''} icon={'pencil-square'} name={' '}/> リテラチュア
            </h5>
          </div>
          <div className="text-start fs-5 px-5 col-12 col-md-6  m-auto">
          彩られていけば幻想が
    ...
    <div className="col-12 mt-5 m-auto bg-4 text-light mb-3 px-2 py-4">
      <div className="text-center ">
        <h5>
        <Icon variant={''} icon={'pencil-square'} name={' '}/>Literature [reina ueda]
        </h5>
      </div>
      <div className="text-start fs-5 px-5 col-12 col-md-6  m-auto">
    ...
    <div className="col-12 mt-5 m-auto bg-4 text-light mb-3 px-2 py-4">
          <div className="text-center ">
            <h5>
              <Icon variant={''} icon={'pencil-square'} name={' '}/> Служить России
            </h5>
          </div>
          <div className="text-start fs-5 px-5 col-12 col-md-6  m-auto">
          Полки идут стеной,
    ...
    <div className="col-12 mt-5 m-auto bg-4 text-light mb-3 px-2 py-4">
      <div className="text-center ">
        <h5>
        <Icon variant={''} icon={'pencil-square'} name={' '}/> Untuk melayani Rusia
        </h5>
      </div>
      <div className="text-start fs-5 px-5 col-12 col-md-6  m-auto">
