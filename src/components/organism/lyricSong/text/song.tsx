  ...
  const data=
  {
    data:{
        original:{
            ...
            korobushka:{
                    title:`Коробейники`,
                    lirik:` Ой, полным, полна моя коробушка
            ...
            yorunikakeru:{
                title:`夜に駆ける`,
                lirik:`沈むように 溶けてゆくように 二人だけの空が広がる夜に
                        「さよなら」だけだった その一言で全てが分かった
                        日が沈み出した空と君の姿 フェンス越しに重なっていた 初めて会った日から
                        僕の心の全てを奪った どこか儚い空気を纏う君は 寂しい目をしてたんだ
                        いつだってチックタックと鳴る世界で何度だってさ
                        触れる心無い言葉うるさい声に涙が零れそうでも ありきたりな喜び
                        きっと二人なら見つけられる 騒がしい日々に 笑えない君に
                        思い付く限り眩しい明日を 明けない夜に落ちてゆく前に 僕の手を掴んでほら
                        忘れてしまいたくて 閉じ込めた日々も 抱きしめた温もりで溶かすから
                        怖くないよ いつか日が昇るまで 二人でいよう 君にしか見えない
                        何かを見つめる君が嫌いだ 見惚れているかのような 恋するような
                        そんな顔が嫌いだ 信じていたいけど信じれないこと
                        そんなのどうしたってきっと これからだっていくつもあって
                        そのたんび怒って泣いていくの それでもきっといつかはきっと僕らはきっと
                        分かり合えるさ 信じてるよ もう嫌だって 疲れたんだって
                        がむしゃらに差し伸べた僕の手を振り払う君 もう嫌だって 疲れたよなんて
                        本当は僕も言いたいんだ ほらまたチックタックと鳴る世界で何度だってさ
                        君の為に用意した言葉どれも届かない 「終わりにしたい」だなんてさ
                        釣られて言葉にした時 君は初めて笑った 騒がしい日々に笑えなくなっていた
                        僕の目に映る君は綺麗だ 明けない夜に溢れた涙も 君の笑顔に溶けていく
                        変わらない日々に泣いていた僕を 君は優しく終わりへと誘う 沈むように
                        溶けてゆくように 染み付いた霧が晴れる 忘れてしまいたくて
                        閉じ込めた日々に 差し伸べてくれた君の手を取る
                        涼しい風が空を泳ぐように今吹き抜けていく 繋いだ手を離さないでよ 二人今
                        夜に駆け出していく`
            },
           literature:{
                title:`リテラチュア`,
           ...
           toServeRusia:{
                title:`Служить России`,
                lirik:` Полки идут стеной,
            ...
            chernoglaza:{
                    title:`Черноглазая казачка`,
                    lirik:`Черноглазая казачка
                            Подковала мне коня.
        ...
        translate:{
            comet:{
                ...
                lirik:`Sekarang, di malam yang tenang
            ...
            korobushka:{
                    title:`korobeiniki`,
                    lirik:`Oh, so full, so full is my crate,
            ...
            yorunikakeru:{
                ...
                lirik:` Seperti tenggelam dan melebur ke dalamnya Langit bagi kita berdua membentang
                        ...
                        Kau telah merebut seluruh hatiku Kau yang diselimuti oleh udara entah
                        kenapa Memperlihatkan mata yang sedih Selalu berbunyi dengan "tick
                        tack" Entah berapa kali di dunia berdering ini Dalam suara berisik
                        yang tak dapat disentuh hatiku Meski air mata seolah mengalir Aku
                        yakin kita berdua pasti dapat menemukan kebahagiaan yang biasa Kau
                        yang tak tersenyum di hari yang bising ini Pasti akan melihat esok
                        yang menyilaukan Sebelum malam berubah menjadi pagi hari Genggamlah
                        tanganku ini Meski dalam hari yang kau benci dan ingin kau lupakan Aku
                        akan melelehkannya dengan kehangatanku Jangan takut hingga matahari
                        terbit kembali Mari bersama-sama Aku hanya bisa melihatmu Aku benci
                        saat kau memikirkan sesuatu Seperti saat kau mencintai dan juga jatuh
                        cinta Aku benci wajah seperti itu Aku tak percaya tapi ingin
                        mempercayainya Aku tak tahu apa yang terjadi tapi kuyakin Pasti akan
                        ada banyak hal mulai sekarang Berapa kali kita akan marah dan menangis
                        Meski begitu suatu hari nanti kita pasti akan melaluinya Saling
                        memahami dan mempercayainya "Sudah cukup" kau yang muak dengan ini
                        Menepis tanganku yang mencoba menggapaimu dengan sekuat tenaga Aku
                        juga muak dengan "sudah cukup"-mu Sebenarnya aku ingin mengatakan hal
                        itu Lihatlah berbunyi "tick tack" lagi Entah berapa kali di dunia
                        berdering ini Kata-kata yang kusiapkan untukmu tetap tak bisa
                        menggapaimu "Aku ingin mengakhirinya saja" Ketika aku mengucapkan hal
                        itu Kau tersenyum untuk pertama kalinya Aku tak bisa tersenyum di hari
                        yang bising ini Kau yang terbayang di mataku begitu indah Air mata
                        yang mengalir di malam sebelum pagi Akan melebur dengan senyumanmu itu
                        Aku menangis dalam hari-hari yang tak berubah Kau yang mengakhirinya
                        dengan lembut mengajakku Seperti tenggelam dan melebur ke dalamnya
                        Kabut yang menyelimuti akhirnya menghilang Di dalam hari yang kubenci
                        dan ingin kulupakan Aku menggenggam tangan yang kau ulurkan padaku
            ...
            toServeRusia:{
                title:`Untuk melayani Rusia`,
                lirik:`Para resimen berjalan seperti dinding yang lurus,
                        Rapi dan teratur,
                        Dan bendera berderau dengan bangga.
                        Komandan dan prajurit - dengan takdir yang yang sama,
                        Kita selamanya akan terkait, temanku.
                        ...
                        Dalam keberanian peperangan,
                        Kami telah menyelamatkan bendera Rusia ini,
                        Dan rumah dan lagu kita.
                        Dan jika ada masalah mendatng, kami akan mendampingimu,
                        Kami akan mempertahankan negeri ini, temanku.
                        Untuk melayani Rusia adalah takdir untuk kau dan aku,
                        Untuk melayani Rusia - negeri yang luar biasa,
                        Dimana matahari terbit di langit biru.
                        Prajurit Rusia berjalan bahu-membahu,
                        Dan meskipun jalan militer tidaklah mudah,
                        Kita akan melayani Rusia dengan iman dan kebenaran.
                        Para resimen berjalan seperti dinding yang lurus,
                        Rapi dan teratur,
                        Dan bersama kami, seluruh Rusia ini.
                        Dia, kau, dan saya adalah keluarga militer kita,
                        Dan itu membuat kami kuat, temanku.
                        Untuk melayani Rusia adalah takdir untuk kau dan aku,
                        Untuk melayani Rusia - negeri yang luar biasa,
                        Dimana matahari terbit di langit biru.
                        Prajurit Rusia berjalan bahu-membahu,
                        ...
                        Prajurit Rusia berjalan bahu-membahu,
                        Dan meskipun jalan militer tidaklah mudah,
                        Kita akan... melayani... Rusia!`
            },
           chernoglaza:{
                title:`gadis cossack bermata gelap`,
                lirik:`gadis cossack bermata gelap
       ...
       text:{
        yorunikakeru_text:{
                text1:`lagu ini terinspirasi dari novel Thanatos no Yuuwaku`,               
                text2:`Novel "The Temptation of Thanatos" yang diposting di situs menulis
                       online ramai menjadi bahan perbincangan. Penulis aslinya adalah "Maya Hoshino". Belum jelas profil detail dari penulis ini, tetapi ada spekulasi bahwa tampaknya dia adalah seorang mahasiswa yang masih aktif. Seperti yang dikatakan penulis itu sendiri, "Saya suka orang yang sedikit kejam",  tulisan singkat "The Temptation of Thanatos" ini adalah cerita yang kelam. The Temptation of Thanatos, atau dalam bahasa Jepang `,               
                text3:` berjudul asli Tanatosu No Yuuwaku (タナトスの誘惑) adalah cerita
                        yang ditulis dengan tema "Aku dan kamu yang frustasi di malam musim panas". Sebenarnya cerita seperti apa yang bisa diceritakan dari tema ini?
                ...
                text4:`lagu ini berisi tentang kontent 18+ yang tak layak didengar oleh
                        anak-anak jauhkan dari telinga anak-anak!`,               
                text5:`jika timbul keinginan untuk bunuh diri klik link di bawah`              
        }
       }
    }
  }
